	...
	<div
		style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 200px; text-align: center;">
			...
			<div
				...
				<span style="float: left;"><a href="login.jsp"><input type="button" style="background: rgb(0, 142, 173); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;"
				value="返回"
				...
				<input type="button"
						...
						value="重置密码（发送邮件）" onclick="f1();"></a> </span>
				</p>
